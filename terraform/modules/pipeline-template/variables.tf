variable "identifier" {
  description = "Unique identifier for the pipeline template"
  type        = string
}

variable "name" {
  description = "Display name for the pipeline template"
  type        = string
}
...
variable "yaml_content" {
  description = "YAML content of the pipeline template"
  type        = string
}
